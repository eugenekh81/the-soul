    ...
    <div className='container container--geo'>
      ...
      <div className='participants__content'>
        <p className='section__description participants__description'>
          Participants filled a registration form, which allowed us to get to
          know each person better. The war forced many people to leave their
          homes, so participants joined our programme from all over the world
          and Ukraine. In terms of the proportion, 29% are outside Ukraine and
          are distributed across Europe and the world, and 71% are in Ukraine
        </p>
        ...
        <Col xs={10} sm={4} lg={5} className='participants__list-container'>
          <ul className='participants__list'>
            ...
            <li className='participants__list-item'>
              ...
              <div className='participants__category'>women under 35 y.o.</div>
            </li>
            <li className='participants__list-item'>
              <div className='participants__percentage'>13%</div>
              <div className='participants__category'>women aged 50+</div>
            </li>
          </ul>
        </Col>
        <Col xs={10} sm={8} lg={5}>
