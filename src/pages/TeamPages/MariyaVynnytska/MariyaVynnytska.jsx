            ...
            <ul className='therapist__list'>
              ...
              <li className='therapist__list-item'>
                {lang === 'en' ? (
                  ...
                  <>
                    <b>Складний період життя:</b> криза, війна, травма, розлука,
                    переїзд, зміна чи втрата роботи, немає внутрішньої опори,
                    тривога, страх щодо майбутнього
                  </>
                )}
              </li>
              <li className='therapist__list-item'>
              ...
              <li className='therapist__list-item'>
                {lang === 'en' ? (
                  <>
                    ...
                    despair, envy, irritability, anger, sadness, shame and guilt
                  </>
                ) : (
                  <>
              ...
              <li className='therapist__list-item'>
                {lang === 'en' ? (
                  <>
                    <b>Decisions and actions:</b> when the choice is necessary,
                    help in finding energy for a change, building a vision for a
                    certain period of life, a dream or a goal.
                  </>
                ) : (
                  <>
              ...
              <li className='therapist__list-item'>
                {lang === 'en' ? (
                  <>
                    <b>Relationship with yourself:</b> rejection of yourself and
                    your body, low self-esteem, sleep disorders, eating
                  ...
                  <>
                    ...
                    задоволення та радості у житті, аутоагресія та розчарування
                  </>
                )}
              </li>
              <li className='therapist__list-item'>
                {lang === 'en' ? (
                  ...
                  <>
                    <b>Адаптація в новій країні</b> під час еміграції, війни чи
                    шлюбу з іноземцем
                  </>
                )}
              </li>
